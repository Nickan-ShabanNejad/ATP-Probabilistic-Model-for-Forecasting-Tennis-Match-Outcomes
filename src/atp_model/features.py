DIFF_FEATURES = [
    ...
    # v0.3 contextual player-history features. These are calculated strictly from
    # matches that occurred before the row being trained, so there is no look-ahead.
    "event_perf_edge", "level_perf_edge", "speed_fit_edge",
...
CONTEXT_FEATURES = [
    ...
    "event_matches_log", "level_matches_log", "speed_fit_matches_log",
]
