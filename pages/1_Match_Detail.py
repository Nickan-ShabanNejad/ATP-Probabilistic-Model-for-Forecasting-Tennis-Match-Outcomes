...
is_grand_slam_match = (
    abs(float(result.get("tournament_level", 0) or 0) - 5.0) < 1e-9
    and int(float(result.get("best_of", 0) or 0)) == 5
)

# The Total Sets 3.5 feature does not exist outside BO5 Grand Slam matches.
# Non-Slam match-detail pages therefore do not render, price, recommend or save it.
