...
with st.expander("Head-to-head model inputs", expanded=True):
    if h2h_matches == 0:
        ...
        if h2h_matches < 4:
            st.info(
                "Fewer than 4 prior meetings: the H2H record is displayed, but directional H2H edges and "
                "H2H matchup-stat differences are neutral in the model."
            )
        st.caption(
            "With 4+ prior meetings, H2H enters the trained feature vector with sample-size shrinkage. "
